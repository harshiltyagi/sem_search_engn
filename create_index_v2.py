...
index_name = 'citeseer_papers_index_v2'  # Replace with your desired index name
...
index_settings = {
    "mappings": {
        "properties": {
            ...
            # Include other fields and their types as needed
        }
    }
}
    ...
    for file_name in files:
        if file_name.endswith('.txt'):
            ...
            with open(file_path, 'r', encoding='utf-8') as file:
                first_line = sanitize_title(file.readline().strip())  # Read the first line as the title
                ...
                es.index(
                    ...
                    body={
                        ...
                        'published_year': int(extracted_year) if extracted_year else None,  # Include extracted year
